...
public:
	...
	graph() {
		...
		nameofstations.push_back("maplewood");
		nameofstations.push_back("riverside");
		nameofstations.push_back("westend");
		nameofstations.push_back("oceanfront");
		nameofstations.push_back("pinecrest");
		nameofstations.push_back("hillcrest");
		nameofstations.push_back("park");
		nameofstations.push_back("elm");
		nameofstations.push_back("cent");
		nameofstations.push_back("hbr");
		nameofstations.push_back("hlcrst");
		nameofstations.push_back("sntst");
		nameofstations.push_back("view");
		nameofstations.push_back("end");
		nameofstations.push_back("valley");
		nameofstations.push_back("profammar");
		nameofstations.push_back("profayan");
		nameofstations.push_back("profanas");
	...
	void addstation(const stationDATA& a) {
		...
		nameofstations.push_back(a.name);
		stations++;
	...
	void removestation(const string& stationName) {
		...
		if (iter != nameofindex.end()) {
			...
			nameofstations.erase(nameofstations.begin() + stationIndex);
